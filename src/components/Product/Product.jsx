      ...
      <section className="product-hero-section">
        <div className="container product-hero-grid">
          <div className="product-hero-content">
            ...
            <h1 className="product-title">Crema Hidratante con Urea 10%</h1>

            <p className="product-description">
              Fórmula magistral diseñada para la restauración profunda de pieles
              secas y rugosas. Una solución clínica de alta precisión que
              combina hidratación intensa con exfoliación suave para una piel
              visiblemente renovada.
            </p>
