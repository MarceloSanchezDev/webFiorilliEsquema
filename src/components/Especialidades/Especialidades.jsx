    ...
    <main className="specialties-main">
      <header className="specialties-hero">
        <div className="specialties-hero-content">
          ...
          <h1 className="specialties-title">Formulas Magistrales</h1>
          ...
          <p className="specialties-description">
            ...
            particulares, lo que aporta valiosas herramientas terapéuticas como:
          </p>
          ...
          <p class="specialties-description">
            ...
            atención sanitaria particular, pues muchos de ellos son considerados
            «casos únicos». Es importante resaltar que este tipo de medicamentos
            se preparan con ingredientes farmacéuticos activos de calidad
            certificada, siguiendo las normas de correcta elaboración y control
            de calidad establecidas al efecto y según las directrices de la
            legislación vigente.
          </p>
        </div>
      </header>
